...
export default function Footer() {
  ...
  «Instagram принадлежит компании Meta, признанной экстремистской организацией. Её деятельность запрещена на территории РФ».
      ...
      <p style={{ fontSize: '10px', color: '#555', opacity: 0.4, marginTop: '8px', textAlign: 'center' }}>
  Все права на товарный знак "ChipaChip" принадлежат правообладателю. Сайт создан для развития личного скилла как демо-портфолио.
</p>
    </footer>
  )
}
