        ...
        <div className="bio-frame frame">
          ...
          <div className="bio-inner">
            ...
            <p className="bio-text">
              <strong>ChipaChip</strong> — исполнитель с богатой историей и солидным бэкграундом. Отличная продуктивность и участие во многих проектах: от телешоу до онлайн баттлов принесли ему заслуженный успех и широкую узнаваемость.
            </p>
